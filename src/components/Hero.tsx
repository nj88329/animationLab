...
const Hero = () => {
  ...
  return (
    <div className = ' flex flex-col md:flex-row  gap-5  h-[90vh] w-[98vw] m-2 rounded-lg'>
        ...
        <div className = "right flex items-center justify-center  bg-[url('/assets/comp.jpeg')] rounded-lg flex-1 sm:flex-[1]  flex justify-center border-2">
            <div className = "bg-blue-500 h-[40vh]  w-[90%] md:w-[75%] lg:w-[40%]  bg-cover bg-center rounded-lg flex justify-center pt-4">
